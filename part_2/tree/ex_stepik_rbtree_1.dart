...
class RBTree<T extends IKey> {
  ...
  // Задача 1: Безопасная проверка наличия ключа
  bool contains(int key) {
    return _findNode(key) != null;
  }
...
void main() {
  ...
  print('Вставляем Worker(id: 10)');
  tree.insert(Worker('Test', 10));
  tree.printTree();

  // Вызвать contains(10) -> ожид. true
